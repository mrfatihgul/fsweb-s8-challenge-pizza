  ...
  return (
    <>
      <main className="banner flex flex-col justify-start items-center w-full">
        ...
        <div className="text-[#FDC913] text-xl max-sm:w-3/5 firsat w-1/3 xl:w-2/5 mx-auto text-center">
          fırsatı kaçırma
        </div>
        <div className="slogan text-white max-sm:w-3/5 w-1/3 xl:w-2/5 mx-auto text-center">
      ...
      <section className="bg-[#FAF7F2] w-full">
        <div className="grid grid-cols-2 gap-4 pt-30 pb-30 w-2/3 mx-auto ">
          <div className="bg-[url('images/iteration-2-images/cta/kart-1.png')] row-span-2 h-full rounded-lg flex flex-col">
            <div className="lezzetus pl-10 pt-10 pr-30 flex text-xxxxxl text-white text-left leading-none">
              Özel Lezzetus
            </div>
            <div className="pl-10 pt-5 flex text-xl text-white text-left">
          ...
          <div className="bg-[url('images/iteration-2-images/cta/kart-2.png')] h-60 rounded-lg flex flex-col">
            <div className="pl-10 pt-10 flex text-xl w-50 text-white text-left font-semibold">
          ...
          <div className="bg-[url('images/iteration-2-images/cta/kart-3.png')] h-60 rounded-lg flex flex-col">
